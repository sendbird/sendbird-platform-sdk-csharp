...
public class InlineResponse20016 {
  ...
  public InlineResponse20016 users(List<SendBirdUser> users) {
    
    this.users = users;
    return this;
  }

  public InlineResponse20016 addUsersItem(SendBirdUser usersItem) {
    if (this.users == null) {
  ...
  **/
  ...
  public InlineResponse20016 next(String next) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.users, inlineResponse20016.users) &&
