...
namespace sendbird_platform_sdk.Model
{
    ...
    public partial class ViewPushPreferencesResponse :  IEquatable<ViewPushPreferencesResponse>, IValidatableObject
    {
        ...
        public ViewPushPreferencesResponse(bool blockPushFromBots = default(bool), bool doNotDisturb = default(bool), bool enablePushForReplies = default(bool), int endHour = default(int), int endMin = default(int), List<string> pushBlockedBotIds = default(List<string>), string pushSound = default(string), SendbirdPushTriggerOption pushTriggerOption = default(SendbirdPushTriggerOption), bool snoozeEnabled = default(bool), long snoozeEndTs = default(long), long snoozeStartTs = default(long), int startHour = default(int), int startMin = default(int), string timezone = default(string), List<UpdatePushPreferencesRequestDndSchedulesInner> dndSchedules = default(List<UpdatePushPreferencesRequestDndSchedulesInner>))
        {
