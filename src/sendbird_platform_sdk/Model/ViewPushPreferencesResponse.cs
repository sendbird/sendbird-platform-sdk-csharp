...
namespace sendbird_platform_sdk.Model
{
    ...
    public partial class ViewPushPreferencesResponse :  IEquatable<ViewPushPreferencesResponse>, IValidatableObject
    {
        ...
        public ViewPushPreferencesResponse(string snoozeStartTs = default, decimal startHour = default(decimal), bool snoozeEnabled = default(bool), decimal endMin = default(decimal), string timezone = default, bool blockPushFromBots = default(bool), List<string> pushBlockedBotIds = default, decimal startMin = default(decimal), string snoozeEndTs = default, bool doNotDisturb = default(bool), decimal endHour = default(decimal), bool enablePushForReplies = default(bool), string pushSound = default, string pushTriggerOption = default)
        {
