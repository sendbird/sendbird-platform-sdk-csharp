...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ReportChannelByUrlResponse :  IEquatable<ReportChannelByUrlResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReportChannelByUrlResponse" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ReportChannelByUrlResponse);
        }

        /// <summary>
        /// Returns true if ReportChannelByUrlResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ReportChannelByUrlResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReportChannelByUrlResponse input)
        {
            if (input == null)
                return false;
