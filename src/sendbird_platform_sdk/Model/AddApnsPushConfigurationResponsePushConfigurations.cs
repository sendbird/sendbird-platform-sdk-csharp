...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AddApnsPushConfigurationResponsePushConfigurations :  IEquatable<AddApnsPushConfigurationResponsePushConfigurations>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddApnsPushConfigurationResponsePushConfigurations" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as AddApnsPushConfigurationResponsePushConfigurations);
        }

        /// <summary>
        /// Returns true if AddApnsPushConfigurationResponsePushConfigurations instances are equal
        /// </summary>
        /// <param name="input">Instance of AddApnsPushConfigurationResponsePushConfigurations to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddApnsPushConfigurationResponsePushConfigurations input)
        {
            if (input == null)
                return false;
