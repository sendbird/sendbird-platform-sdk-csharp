...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetStatisticsDailyResponseStatistics :  IEquatable<GetStatisticsDailyResponseStatistics>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetStatisticsDailyResponseStatistics" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GetStatisticsDailyResponseStatistics);
        }

        /// <summary>
        /// Returns true if GetStatisticsDailyResponseStatistics instances are equal
        /// </summary>
        /// <param name="input">Instance of GetStatisticsDailyResponseStatistics to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetStatisticsDailyResponseStatistics input)
        {
            if (input == null)
                return false;
