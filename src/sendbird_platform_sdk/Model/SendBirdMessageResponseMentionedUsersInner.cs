...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SendBirdMessageResponseMentionedUsersInner :  IEquatable<SendBirdMessageResponseMentionedUsersInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SendBirdMessageResponseMentionedUsersInner" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as SendBirdMessageResponseMentionedUsersInner);
        }

        /// <summary>
        /// Returns true if SendBirdMessageResponseMentionedUsersInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SendBirdMessageResponseMentionedUsersInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SendBirdMessageResponseMentionedUsersInner input)
        {
            if (input == null)
                return false;
