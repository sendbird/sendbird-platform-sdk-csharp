...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ListMessagesResponseOgTag :  IEquatable<ListMessagesResponseOgTag>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListMessagesResponseOgTag" /> class.
        /// </summary>
        ...
        public ListMessagesResponseOgTag(string ogurl = default(string), string ogtitle = default(string), string ogdescription = default(string), ListMessagesResponseOgTagOgImage ogimage = default(ListMessagesResponseOgTagOgImage))
        {
            this.Ogurl = ogurl;
        ...
        public ListMessagesResponseOgTagOgImage Ogimage { get; set; }
        ...
        {
            return this.Equals(input as ListMessagesResponseOgTag);
        }

        /// <summary>
        /// Returns true if ListMessagesResponseOgTag instances are equal
        /// </summary>
        /// <param name="input">Instance of ListMessagesResponseOgTag to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListMessagesResponseOgTag input)
        {
            if (input == null)
                return false;
