...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GcUpdateBanByIdResponse :  IEquatable<GcUpdateBanByIdResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GcUpdateBanByIdResponse" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GcUpdateBanByIdResponse);
        }

        /// <summary>
        /// Returns true if GcUpdateBanByIdResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GcUpdateBanByIdResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GcUpdateBanByIdResponse input)
        {
            if (input == null)
                return false;
