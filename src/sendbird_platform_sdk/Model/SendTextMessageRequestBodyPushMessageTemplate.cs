...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SendTextMessageRequestBodyPushMessageTemplate :  IEquatable<SendTextMessageRequestBodyPushMessageTemplate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SendTextMessageRequestBodyPushMessageTemplate" /> class.
        /// </summary>
        ...
        public SendTextMessageRequestBodyPushMessageTemplate(string title = default(string), string body = default(string))
        {
            this.Title = title;
            this.Body = body;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SendTextMessageRequestBodyPushMessageTemplate {\n");
        ...
        {
            return this.Equals(input as SendTextMessageRequestBodyPushMessageTemplate);
        }

        /// <summary>
        /// Returns true if SendTextMessageRequestBodyPushMessageTemplate instances are equal
        /// </summary>
        /// <param name="input">Instance of SendTextMessageRequestBodyPushMessageTemplate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SendTextMessageRequestBodyPushMessageTemplate input)
        {
            if (input == null)
                return false;
