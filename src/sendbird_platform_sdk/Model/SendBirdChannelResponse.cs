...
namespace sendbird_platform_sdk.Model
{
    ...
    public partial class SendBirdChannelResponse :  IEquatable<SendBirdChannelResponse>, IValidatableObject
    {
        ...
        public SendBirdChannelResponse(string channelUrl = default, string coverUrl = default, decimal createdAt = default, SendBirdGroupChannelCreatedBy createdBy = default, SendBirdUser creator = default, string customType = default, string data = default, SendBirdGroupChannelDisappearingMessage disappearingMessage = default, bool freeze = default, bool ignoreProfanityFilter = default, HiddenStateEnum? hiddenState = default, decimal invitedAt = default, SendBirdGroupChannelInviter inviter = default, bool isAccessCodeRequired = default, bool isBroadcast = default, bool isCreated = default, bool isDiscoverable = default, bool isDistinct = default, bool isEphemeral = default, bool isFrozen = default, bool isHidden = default(bool), bool isPublic = default(bool), bool isPushEnabled = default(bool), bool isSuper = default(bool), decimal joinedAt = default(decimal), decimal joinedMemberCount = default(decimal), SendBirdGroupChannelLastMessage lastMessage = default(SendBirdGroupChannelLastMessage), decimal maxLengthMessage = default(decimal), decimal memberCount = default(decimal), List<SendBirdMember> members = default(List<SendBirdMember>), decimal messageOffsetTimestamp = default(decimal), decimal messageSurvivalSeconds = default(decimal), string myCountPreference = default(string), decimal myLastRead = default(decimal), MyMemberStateEnum? myMemberState = default(MyMemberStateEnum?), MyMutedStateEnum? myMutedState = default(MyMutedStateEnum?), MyPushTriggerOptionEnum? myPushTriggerOption = default(MyPushTriggerOptionEnum?), MyRoleEnum? myRole = default(MyRoleEnum?), string name = default(string), List<SendBirdUser> operators = default(List<SendBirdUser>), SendBirdGroupChannelSmsFallback smsFallback = default(SendBirdGroupChannelSmsFallback), decimal unreadMentionCount = default(decimal), decimal unreadMessageCount = default(decimal), SendBirdGroupChannelChannel channel = default(SendBirdGroupChannelChannel), bool isDynamicPartitioned = default(bool), decimal participantCount = default(decimal))
        {
            CreatedBy = createdBy;
            ...
            Freeze = freeze;
            IgnoreProfanityFilter = ignoreProfanityFilter;
            ...
            Channel = channel;
            IsDynamicPartitioned = isDynamicPartitioned;
        ...
        public override bool Equals(object input) =>
            Equals(input as SendBirdChannelResponse);
