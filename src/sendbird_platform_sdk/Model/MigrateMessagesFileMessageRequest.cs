...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MigrateMessagesFileMessageRequest :  IEquatable<MigrateMessagesFileMessageRequest>, IValidatableObject
    {
        /// <summary>
        /// Defines MessageType
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MigrateMessagesFileMessageRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MigrateMessagesFileMessageRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MigrateMessagesFileMessageRequest" /> class.
        /// </summary>
        ...
        public MigrateMessagesFileMessageRequest(string userId = default(string), MessageTypeEnum messageType = default(MessageTypeEnum), string url = default(string), long timestamp = default(long), string fileName = default(string), int fileSize = default(int), string fileType = default(string), List<MigrateMessagesFileMessageRequestThumbnailsInner> thumbnails = default(List<MigrateMessagesFileMessageRequestThumbnailsInner>), bool requireAuth = default(bool), string customType = default(string), string customField = default(string), List<string> mentionedUserIds = default(List<string>), string dedupId = default(string), List<Object> sortedMetaarray = default(List<Object>))
        {
            // to ensure "userId" is required (not null)
            if (userId == null)
            {
                throw new InvalidDataException("userId is a required property for MigrateMessagesFileMessageRequest and cannot be null");
            }
            else
            {
                this.UserId = userId;
            ...
            if (messageType == null)
            {
                throw new InvalidDataException("messageType is a required property for MigrateMessagesFileMessageRequest and cannot be null");
            }
            else
            {
            ...
            if (url == null)
            {
                throw new InvalidDataException("url is a required property for MigrateMessagesFileMessageRequest and cannot be null");
            }
            else
            {
                this.Url = url;
            ...
            if (timestamp == null)
            {
                throw new InvalidDataException("timestamp is a required property for MigrateMessagesFileMessageRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as MigrateMessagesFileMessageRequest);
        }

        /// <summary>
        /// Returns true if MigrateMessagesFileMessageRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of MigrateMessagesFileMessageRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MigrateMessagesFileMessageRequest input)
        {
            if (input == null)
                return false;
