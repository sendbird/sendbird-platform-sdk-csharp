...
namespace sendbird_platform_sdk.Model
{
    ...
    public partial class InlineResponse20064 :  IEquatable<InlineResponse20064>, IValidatableObject
    {
        ...
        public InlineResponse20064(string requestId = default(string), string dataType = default(string), string status = default(string), string format = default(string), string csvDelimiter = default(string), string timezone = default(string), decimal createdAt = default(decimal), decimal startTs = default(decimal), decimal endTs = default(decimal), List<string> channelUrls = default(List<string>), List<string> channelCustomTypes = default(List<string>), List<string> senderIds = default(List<string>), InlineResponse20063File file = default(InlineResponse20063File), List<decimal> userIds = default(List<decimal>))
        {
