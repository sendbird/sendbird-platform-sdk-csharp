...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateExtraDataInAMessageRequest :  IEquatable<UpdateExtraDataInAMessageRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateExtraDataInAMessageRequest" /> class.
        /// </summary>
        /// <param name="mode">mode.</param>
        /// <param name="sortedMetaarray">sortedMetaarray.</param>
        /// <param name="upsert">upsert.</param>
        public UpdateExtraDataInAMessageRequest(string mode = default(string), List<SendbirdSortedMetaarrayInner> sortedMetaarray = default(List<SendbirdSortedMetaarrayInner>), bool upsert = default(bool))
        {
            this.Mode = mode;
        ...
        {
            return this.Equals(input as UpdateExtraDataInAMessageRequest);
        }

        /// <summary>
        /// Returns true if UpdateExtraDataInAMessageRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateExtraDataInAMessageRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateExtraDataInAMessageRequest input)
        {
            if (input == null)
                return false;
