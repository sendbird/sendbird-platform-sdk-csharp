...
namespace sendbird_platform_sdk.Model
{
    ...
    public partial class SendBirdMessageResponseUser :  IEquatable<SendBirdMessageResponseUser>, IValidatableObject
    {
        ...
        public SendBirdMessageResponseUser(bool requireAuthForProfileImage = default(bool), bool isActive = default(bool), string role = default(string), string userId = default(string), string nickname = default(string), string profileUrl = default(string), InlineResponse200 metadata = default(InlineResponse200))
        {
