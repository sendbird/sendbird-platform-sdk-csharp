...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse20071ReportLogs :  IEquatable<InlineResponse20071ReportLogs>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20071ReportLogs" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as InlineResponse20071ReportLogs);
        }

        /// <summary>
        /// Returns true if InlineResponse20071ReportLogs instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20071ReportLogs to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20071ReportLogs input)
        {
            if (input == null)
                return false;
