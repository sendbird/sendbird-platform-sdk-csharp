...
namespace sendbird_platform_sdk.Model
{
    ...
    public partial class UpdateBotByIdResponse :  IEquatable<UpdateBotByIdResponse>, IValidatableObject
    {
        ...
        public UpdateBotByIdResponse(CreateBotResponseBot bot = default(CreateBotResponseBot), string botCallbackUrl = default(string), bool enableMarkAsRead = default(bool), bool isPrivacyMode = default(bool), bool showMember = default(bool), decimal channelInvitationPreference = default(decimal))
        {
            this.Bot = bot;
