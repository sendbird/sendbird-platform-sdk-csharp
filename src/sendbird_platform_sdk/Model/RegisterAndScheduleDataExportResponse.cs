...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RegisterAndScheduleDataExportResponse :  IEquatable<RegisterAndScheduleDataExportResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as RegisterAndScheduleDataExportResponse);
        }

        /// <summary>
        /// Returns true if RegisterAndScheduleDataExportResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of RegisterAndScheduleDataExportResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RegisterAndScheduleDataExportResponse input)
        {
            if (input == null)
                return false;
