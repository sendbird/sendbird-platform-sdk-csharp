...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MigrateMessagesTextMessageRequest :  IEquatable<MigrateMessagesTextMessageRequest>, IValidatableObject
    {
        /// <summary>
        /// Defines MessageType
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MigrateMessagesTextMessageRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MigrateMessagesTextMessageRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MigrateMessagesTextMessageRequest" /> class.
        /// </summary>
        ...
        public MigrateMessagesTextMessageRequest(string userId = default(string), MessageTypeEnum messageType = default(MessageTypeEnum), string message = default(string), long timestamp = default(long), string customType = default(string), List<string> mentionedUserIds = default(List<string>), string data = default(string), string dedupId = default(string), List<Object> sortedMetaarray = default(List<Object>))
        {
            // to ensure "userId" is required (not null)
            if (userId == null)
            {
                throw new InvalidDataException("userId is a required property for MigrateMessagesTextMessageRequest and cannot be null");
            }
            else
            {
                this.UserId = userId;
            ...
            if (messageType == null)
            {
                throw new InvalidDataException("messageType is a required property for MigrateMessagesTextMessageRequest and cannot be null");
            }
            else
            {
            ...
            if (message == null)
            {
                throw new InvalidDataException("message is a required property for MigrateMessagesTextMessageRequest and cannot be null");
            }
            else
            {
            ...
            if (timestamp == null)
            {
                throw new InvalidDataException("timestamp is a required property for MigrateMessagesTextMessageRequest and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MigrateMessagesTextMessageRequest {\n");
        ...
        {
            return this.Equals(input as MigrateMessagesTextMessageRequest);
        }

        /// <summary>
        /// Returns true if MigrateMessagesTextMessageRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of MigrateMessagesTextMessageRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MigrateMessagesTextMessageRequest input)
        {
            if (input == null)
                return false;
