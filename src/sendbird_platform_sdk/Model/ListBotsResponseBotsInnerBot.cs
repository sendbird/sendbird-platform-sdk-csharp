...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ListBotsResponseBotsInnerBot :  IEquatable<ListBotsResponseBotsInnerBot>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListBotsResponseBotsInnerBot" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListBotsResponseBotsInnerBot() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListBotsResponseBotsInnerBot" /> class.
        /// </summary>
        ...
        public ListBotsResponseBotsInnerBot(string aiAgentType = default(string), Object botMetadata = default(Object), string botNickname = default(string), string botProfileUrl = default(string), bool botRequireAuthForProfileImage = default(bool), string botToken = default(string), string botType = default(string), string botUserid = default(string))
        {
            // to ensure "botUserid" is required (not null)
            if (botUserid == null)
            {
                throw new InvalidDataException("botUserid is a required property for ListBotsResponseBotsInnerBot and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as ListBotsResponseBotsInnerBot);
        }

        /// <summary>
        /// Returns true if ListBotsResponseBotsInnerBot instances are equal
        /// </summary>
        /// <param name="input">Instance of ListBotsResponseBotsInnerBot to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListBotsResponseBotsInnerBot input)
        {
            if (input == null)
                return false;
