...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SetDomainFilterDataImageModeration :  IEquatable<SetDomainFilterDataImageModeration>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SetDomainFilterDataImageModeration" /> class.
        /// </summary>
        /// <param name="type">type.</param>
        /// <param name="softBlock">softBlock.</param>
        /// <param name="limits">limits.</param>
        /// <param name="checkUrls">checkUrls.</param>
        public SetDomainFilterDataImageModeration(int type = default(int), bool softBlock = default(bool), SetDomainFilterDataImageModerationLimits limits = default(SetDomainFilterDataImageModerationLimits), bool checkUrls = default(bool))
        {
            this.Type = type;
        ...
        public SetDomainFilterDataImageModerationLimits Limits { get; set; }
        ...
        {
            return this.Equals(input as SetDomainFilterDataImageModeration);
        }

        /// <summary>
        /// Returns true if SetDomainFilterDataImageModeration instances are equal
        /// </summary>
        /// <param name="input">Instance of SetDomainFilterDataImageModeration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SetDomainFilterDataImageModeration input)
        {
            if (input == null)
                return false;
