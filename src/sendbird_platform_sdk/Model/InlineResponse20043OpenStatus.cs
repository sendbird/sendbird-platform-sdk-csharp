...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse20043OpenStatus :  IEquatable<InlineResponse20043OpenStatus>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20043OpenStatus" /> class.
        /// </summary>
        /// <param name="userId">userId.</param>
        /// <param name="channelUrl">channelUrl.</param>
        /// <param name="hasOpened">hasOpened.</param>
        public InlineResponse20043OpenStatus(string userId = default(string), string channelUrl = default(string), bool hasOpened = default(bool))
        {
            this.UserId = userId;
        ...
        {
            return this.Equals(input as InlineResponse20043OpenStatus);
        }

        /// <summary>
        /// Returns true if InlineResponse20043OpenStatus instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20043OpenStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20043OpenStatus input)
        {
            if (input == null)
                return false;
