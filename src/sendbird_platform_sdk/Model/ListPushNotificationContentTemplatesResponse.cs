...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ListPushNotificationContentTemplatesResponse :  IEquatable<ListPushNotificationContentTemplatesResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ListPushNotificationContentTemplatesResponse);
        }

        /// <summary>
        /// Returns true if ListPushNotificationContentTemplatesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ListPushNotificationContentTemplatesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListPushNotificationContentTemplatesResponse input)
        {
            if (input == null)
                return false;
