...
namespace sendbird_platform_sdk.Model
{
    ...
    public partial class ListReportsOnChannelByUrlResponse :  IEquatable<ListReportsOnChannelByUrlResponse>, IValidatableObject
    {
        ...
        public ListReportsOnChannelByUrlResponse(List<ListReportsOnMessageByIdResponseReportLogs> reportLogs = default(List<ListReportsOnMessageByIdResponseReportLogs>), string next = default(string))
        {
