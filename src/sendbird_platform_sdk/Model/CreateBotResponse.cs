...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateBotResponse :  IEquatable<CreateBotResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateBotResponse" /> class.
        /// </summary>
        ...
        public CreateBotResponse(CreateBotResponseBot bot = default(CreateBotResponseBot), string botCallbackUrl = default(string), bool enableMarkAsRead = default(bool), bool isPrivacyMode = default(bool), bool showMember = default(bool), decimal channelInvitationPreference = default(decimal))
        {
            this.Bot = bot;
        ...
        {
            return this.Equals(input as CreateBotResponse);
        }

        /// <summary>
        /// Returns true if CreateBotResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateBotResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateBotResponse input)
        {
            if (input == null)
                return false;
