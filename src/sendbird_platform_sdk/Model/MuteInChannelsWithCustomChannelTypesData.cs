...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MuteInChannelsWithCustomChannelTypesData :  IEquatable<MuteInChannelsWithCustomChannelTypesData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MuteInChannelsWithCustomChannelTypesData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MuteInChannelsWithCustomChannelTypesData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MuteInChannelsWithCustomChannelTypesData" /> class.
        /// </summary>
        ...
        public MuteInChannelsWithCustomChannelTypesData(List<string> channelCustomTypes = default(List<string>))
        {
            ...
            {
                throw new InvalidDataException("channelCustomTypes is a required property for MuteInChannelsWithCustomChannelTypesData and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Specifies an array of one or more custom channel types, in order to mute the user in channels with the channel types. The user is permanently muted unless unmuted (10 years, technically).</value>
        ...
        {
            return this.Equals(input as MuteInChannelsWithCustomChannelTypesData);
        }

        /// <summary>
        /// Returns true if MuteInChannelsWithCustomChannelTypesData instances are equal
        /// </summary>
        /// <param name="input">Instance of MuteInChannelsWithCustomChannelTypesData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MuteInChannelsWithCustomChannelTypesData input)
        {
            if (input == null)
                return false;
