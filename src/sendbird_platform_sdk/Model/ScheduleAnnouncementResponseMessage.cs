...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ScheduleAnnouncementResponseMessage :  IEquatable<ScheduleAnnouncementResponseMessage>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScheduleAnnouncementResponseMessage" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ScheduleAnnouncementResponseMessage);
        }

        /// <summary>
        /// Returns true if ScheduleAnnouncementResponseMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of ScheduleAnnouncementResponseMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScheduleAnnouncementResponseMessage input)
        {
            if (input == null)
                return false;
