...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GcViewMuteByIdResponse :  IEquatable<GcViewMuteByIdResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GcViewMuteByIdResponse" /> class.
        /// </summary>
        ...
        public GcViewMuteByIdResponse(bool isMuted = default(bool), decimal remainingDuration = default(decimal), decimal startAt = default(decimal), decimal endAt = default(decimal), string description = default(string))
        {
        ...
        {
            return this.Equals(input as GcViewMuteByIdResponse);
        }

        /// <summary>
        /// Returns true if GcViewMuteByIdResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GcViewMuteByIdResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GcViewMuteByIdResponse input)
        {
            if (input == null)
                return false;
