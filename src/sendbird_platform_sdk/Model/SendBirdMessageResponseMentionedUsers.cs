...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SendBirdMessageResponseMentionedUsers :  IEquatable<SendBirdMessageResponseMentionedUsers>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SendBirdMessageResponseMentionedUsers" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as SendBirdMessageResponseMentionedUsers);
        }

        /// <summary>
        /// Returns true if SendBirdMessageResponseMentionedUsers instances are equal
        /// </summary>
        /// <param name="input">Instance of SendBirdMessageResponseMentionedUsers to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SendBirdMessageResponseMentionedUsers input)
        {
            if (input == null)
                return false;
