...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OcUpdateBanByIdResponse :  IEquatable<OcUpdateBanByIdResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OcUpdateBanByIdResponse" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as OcUpdateBanByIdResponse);
        }

        /// <summary>
        /// Returns true if OcUpdateBanByIdResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of OcUpdateBanByIdResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OcUpdateBanByIdResponse input)
        {
            if (input == null)
                return false;
