...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SendbirdGroupChannelDetailChannel :  IEquatable<SendbirdGroupChannelDetailChannel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SendbirdGroupChannelDetailChannel" /> class.
        /// </summary>
        ...
        public SendbirdGroupChannelDetailChannel(string channelUrl = default(string), string coverUrl = default(string), long createdAt = default(long), string customType = default(string), string data = default(string), int maxLengthMessage = default(int), int memberCount = default(int), string name = default(string))
        {
        ...
        {
            return this.Equals(input as SendbirdGroupChannelDetailChannel);
        }

        /// <summary>
        /// Returns true if SendbirdGroupChannelDetailChannel instances are equal
        /// </summary>
        /// <param name="input">Instance of SendbirdGroupChannelDetailChannel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SendbirdGroupChannelDetailChannel input)
        {
            if (input == null)
                return false;
