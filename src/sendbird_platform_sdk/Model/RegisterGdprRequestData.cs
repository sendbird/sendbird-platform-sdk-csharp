...
namespace sendbird_platform_sdk.Model
{
    ...
    public partial class RegisterGdprRequestData :  IEquatable<RegisterGdprRequestData>, IValidatableObject
    {
        ...
        public RegisterGdprRequestData(string action = default(string), List<int> userIds = default(List<int>), string channelDeleteOption = default(string), string userId = default(string))
        {
