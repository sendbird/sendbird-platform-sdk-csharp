...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse20070ReportLogs :  IEquatable<InlineResponse20070ReportLogs>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20070ReportLogs" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as InlineResponse20070ReportLogs);
        }

        /// <summary>
        /// Returns true if InlineResponse20070ReportLogs instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20070ReportLogs to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20070ReportLogs input)
        {
            if (input == null)
                return false;
