...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdatePushPreferencesRequest :  IEquatable<UpdatePushPreferencesRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdatePushPreferencesRequest" /> class.
        /// </summary>
        ...
        public UpdatePushPreferencesRequest(bool blockPushFromBots = default(bool), bool doNotDisturb = default(bool), bool enablePushForReplies = default(bool), int endHour = default(int), int endMin = default(int), List<string> pushBlockedBotIds = default(List<string>), string pushSound = default(string), SendbirdPushTriggerOption pushTriggerOption = default(SendbirdPushTriggerOption), bool snoozeEnabled = default(bool), long snoozeEndTs = default(long), long snoozeStartTs = default(long), int startHour = default(int), int startMin = default(int), string timezone = default(string), List<UpdatePushPreferencesRequestDndSchedulesInner> dndSchedules = default(List<UpdatePushPreferencesRequestDndSchedulesInner>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdatePushPreferencesRequest {\n");
        ...
        {
            return this.Equals(input as UpdatePushPreferencesRequest);
        }

        /// <summary>
        /// Returns true if UpdatePushPreferencesRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdatePushPreferencesRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdatePushPreferencesRequest input)
        {
            if (input == null)
                return false;
