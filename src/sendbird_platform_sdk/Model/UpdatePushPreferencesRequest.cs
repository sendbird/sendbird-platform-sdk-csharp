...
namespace sendbird_platform_sdk.Model
{
    ...
    public partial class UpdatePushPreferencesRequest :  IEquatable<UpdatePushPreferencesRequest>, IValidatableObject
    {
        ...
        public UpdatePushPreferencesRequest(bool blockPushFromBots = default(bool), bool doNotDisturb = default(bool), bool enablePushForReplies = default(bool), int endHour = default(int), int endMin = default(int), List<string> pushBlockedBotIds = default(List<string>), string pushSound = default(string), SendbirdPushTriggerOption pushTriggerOption = default(SendbirdPushTriggerOption), bool snoozeEnabled = default(bool), long snoozeEndTs = default(long), long snoozeStartTs = default(long), int startHour = default(int), int startMin = default(int), string timezone = default(string))
        {
