...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AddExtraDataToAMessageResponse :  IEquatable<AddExtraDataToAMessageResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddExtraDataToAMessageResponse" /> class.
        /// </summary>
        /// <param name="sortedMetaarray">sortedMetaarray.</param>
        public AddExtraDataToAMessageResponse(List<SendbirdSortedMetaarrayInner> sortedMetaarray = default(List<SendbirdSortedMetaarrayInner>))
        {
        ...
        {
            return this.Equals(input as AddExtraDataToAMessageResponse);
        }

        /// <summary>
        /// Returns true if AddExtraDataToAMessageResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AddExtraDataToAMessageResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddExtraDataToAMessageResponse input)
        {
            if (input == null)
                return false;
