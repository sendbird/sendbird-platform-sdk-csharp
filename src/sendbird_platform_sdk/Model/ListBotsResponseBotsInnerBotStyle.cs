...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ListBotsResponseBotsInnerBotStyle :  IEquatable<ListBotsResponseBotsInnerBotStyle>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListBotsResponseBotsInnerBotStyle" /> class.
        /// </summary>
        ...
        public ListBotsResponseBotsInnerBotStyle(bool autoOpen = default(bool), ListBotsResponseBotsInnerBotStyleColor color = default(ListBotsResponseBotsInnerBotStyleColor), string toggleButtonType = default(string), string toggleButtonUrl = default(string))
        {
        ...
        /// </summary>
        [DataMember(Name="toggle_button_url", EmitDefaultValue=true)]
        ...
        {
            return this.Equals(input as ListBotsResponseBotsInnerBotStyle);
        }

        /// <summary>
        /// Returns true if ListBotsResponseBotsInnerBotStyle instances are equal
        /// </summary>
        /// <param name="input">Instance of ListBotsResponseBotsInnerBotStyle to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListBotsResponseBotsInnerBotStyle input)
        {
            if (input == null)
                return false;
