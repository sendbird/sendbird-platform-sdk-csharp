...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdatePushPreferencesForChannelByUrlResponse :  IEquatable<UpdatePushPreferencesForChannelByUrlResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdatePushPreferencesForChannelByUrlResponse" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UpdatePushPreferencesForChannelByUrlResponse);
        }

        /// <summary>
        /// Returns true if UpdatePushPreferencesForChannelByUrlResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdatePushPreferencesForChannelByUrlResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdatePushPreferencesForChannelByUrlResponse input)
        {
            if (input == null)
                return false;
