...
namespace sendbird_platform_sdk.Model
{
    ...
    public partial class SendBirdAdminMessage :  IEquatable<SendBirdAdminMessage>, IValidatableObject
    {
        ...
        public SendBirdAdminMessage(SendBirdAppleCriticalAlertOptions appleCriticalAlertOptions = default(SendBirdAppleCriticalAlertOptions), string channelType = default, string channelUrl = default, decimal createdAt = default(decimal), string customType = default, string data = default, bool isReplyToChannel = default(bool), string mentionType = default, List<SendBirdUser> mentionedUsers = default(List<SendBirdUser>), string message = default, decimal messageId = default(decimal), MessageTypeEnum? messageType = default(MessageTypeEnum?), SBObject metaArray = default(SBObject), List<SendBirdMessageMetaArray> metaArrays = default(List<SendBirdMessageMetaArray>), SendBirdOGMetaData ogMetaData = default(SendBirdOGMetaData), SendBirdMessageResponse parentMessage = default(SendBirdMessageResponse), decimal parentMessageId = default(decimal), string parentMessageText = default, List<SendBirdReaction> reactions = default(List<SendBirdReaction>), SendingStatusEnum? sendingStatus = default(SendingStatusEnum?), bool silent = default(bool), SendBirdThreadInfo threadInfo = default(SendBirdThreadInfo), SBObject translations = default(SBObject), decimal updatedAt = default(decimal))
        {
