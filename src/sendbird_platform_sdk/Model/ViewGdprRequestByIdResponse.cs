...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ViewGdprRequestByIdResponse :  IEquatable<ViewGdprRequestByIdResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ViewGdprRequestByIdResponse" /> class.
        /// </summary>
        ...
        public ViewGdprRequestByIdResponse(string requestId = default, string action = default, string status = default, string userId = default, ListDataExportsByMessageChannelOrUserResponseExportedDataInnerFile files = default(ListDataExportsByMessageChannelOrUserResponseExportedDataInnerFile), List<string> userIds = default, string channelDeleteOption = default, decimal createdAt = default(decimal))
        {
        ...
        {
            return this.Equals(input as ViewGdprRequestByIdResponse);
        }

        /// <summary>
        /// Returns true if ViewGdprRequestByIdResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ViewGdprRequestByIdResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ViewGdprRequestByIdResponse input)
        {
            if (input == null)
                return false;
