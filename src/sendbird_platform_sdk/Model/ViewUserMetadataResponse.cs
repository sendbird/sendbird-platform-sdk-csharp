...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ViewUserMetadataResponse :  IEquatable<ViewUserMetadataResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ViewUserMetadataResponse);
        }

        /// <summary>
        /// Returns true if ViewUserMetadataResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ViewUserMetadataResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ViewUserMetadataResponse input)
        {
            if (input == null)
                return false;
