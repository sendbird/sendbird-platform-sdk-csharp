...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ViewCountPreferenceOfChannelByUrlResponse :  IEquatable<ViewCountPreferenceOfChannelByUrlResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ViewCountPreferenceOfChannelByUrlResponse);
        }

        /// <summary>
        /// Returns true if ViewCountPreferenceOfChannelByUrlResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ViewCountPreferenceOfChannelByUrlResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ViewCountPreferenceOfChannelByUrlResponse input)
        {
            if (input == null)
                return false;
