...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ViewBotByIdResponse :  IEquatable<ViewBotByIdResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ViewBotByIdResponse" /> class.
        /// </summary>
        ...
        public ViewBotByIdResponse(ViewBotByIdResponseBot bot = default(ViewBotByIdResponseBot), string botCallbackUrl = default(string), bool enableMarkAsRead = default(bool), bool isPrivacyMode = default(bool), bool showMember = default(bool), int channelInvitationPreference = default(int))
        {
            this.Bot = bot;
        ...
        {
            return this.Equals(input as ViewBotByIdResponse);
        }

        /// <summary>
        /// Returns true if ViewBotByIdResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ViewBotByIdResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ViewBotByIdResponse input)
        {
            if (input == null)
                return false;
