...
namespace sendbird_platform_sdk.Model
{
    ...
    public partial class ViewBotByIdResponse :  IEquatable<ViewBotByIdResponse>, IValidatableObject
    {
        ...
        public ViewBotByIdResponse(CreateBotResponseBot bot = default(CreateBotResponseBot), string botCallbackUrl = default(string), bool enableMarkAsRead = default(bool), bool isPrivacyMode = default(bool), bool showMember = default(bool), decimal channelInvitationPreference = default(decimal))
        {
            this.Bot = bot;
