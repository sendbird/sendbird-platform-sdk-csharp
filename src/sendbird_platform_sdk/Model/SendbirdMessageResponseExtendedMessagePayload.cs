...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SendbirdMessageResponseExtendedMessagePayload :  IEquatable<SendbirdMessageResponseExtendedMessagePayload>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SendbirdMessageResponseExtendedMessagePayload" /> class.
        /// </summary>
        ...
        public SendbirdMessageResponseExtendedMessagePayload(Object customView = default(Object), List<string> suggestedReplies = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SendbirdMessageResponseExtendedMessagePayload {\n");
        ...
        {
            return this.Equals(input as SendbirdMessageResponseExtendedMessagePayload);
        }

        /// <summary>
        /// Returns true if SendbirdMessageResponseExtendedMessagePayload instances are equal
        /// </summary>
        /// <param name="input">Instance of SendbirdMessageResponseExtendedMessagePayload to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SendbirdMessageResponseExtendedMessagePayload input)
        {
            if (input == null)
                return false;
