...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SendFileMessageRequestBody :  IEquatable<SendFileMessageRequestBody>, IValidatableObject
    {
        /// <summary>
        /// Defines MentionType
        /// </summary>
        ...
        /// </summary>
        /// <value>Specifies the type of the message. The value of FILE represents a file message.</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SendFileMessageRequestBody" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SendFileMessageRequestBody() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SendFileMessageRequestBody" /> class.
        /// </summary>
        ...
        /// <param name="messageType">Specifies the type of the message. The value of FILE represents a file message. (required).</param>
        ...
        public SendFileMessageRequestBody(string apnsBundleId = default(string), Object appleCriticalAlertOptions = default(Object), long createdAt = default(long), string customType = default(string), string data = default(string), string dedupId = default(string), SendbirdFile files = default(SendbirdFile), bool isSilent = default(bool), bool markAsRead = default(bool), MentionTypeEnum? mentionType = default(MentionTypeEnum?), List<string> mentionedUserIds = default(List<string>), MessageTypeEnum messageType = default(MessageTypeEnum), bool requireAuth = default(bool), bool sendPush = default(bool), List<SendbirdSortedMetaarrayInner> sortedMetaarray = default(List<SendbirdSortedMetaarrayInner>), string sound = default(string), string thumbnail1 = default(string), string thumbnail2 = default(string), string thumbnail3 = default(string), List<string> thumbnails = default(List<string>), decimal volume = default(decimal))
        {
            // to ensure "files" is required (not null)
            if (files == null)
            {
                throw new InvalidDataException("files is a required property for SendFileMessageRequestBody and cannot be null");
            }
            else
            {
                this.Files = files;
            ...
            if (messageType == null)
            {
                throw new InvalidDataException("messageType is a required property for SendFileMessageRequestBody and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as SendFileMessageRequestBody);
        }

        /// <summary>
        /// Returns true if SendFileMessageRequestBody instances are equal
        /// </summary>
        /// <param name="input">Instance of SendFileMessageRequestBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SendFileMessageRequestBody input)
        {
            if (input == null)
                return false;
