...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ListAnnouncementsResponseAnnouncementsInner :  IEquatable<ListAnnouncementsResponseAnnouncementsInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListAnnouncementsResponseAnnouncementsInner" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ListAnnouncementsResponseAnnouncementsInner);
        }

        /// <summary>
        /// Returns true if ListAnnouncementsResponseAnnouncementsInner instances are equal
        /// </summary>
        /// <param name="input">Instance of ListAnnouncementsResponseAnnouncementsInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListAnnouncementsResponseAnnouncementsInner input)
        {
            if (input == null)
                return false;
