...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SendTextMessageRequestBodyPushMessageTemplateOneOf :  IEquatable<SendTextMessageRequestBodyPushMessageTemplateOneOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SendTextMessageRequestBodyPushMessageTemplateOneOf" /> class.
        /// </summary>
        ...
        public SendTextMessageRequestBodyPushMessageTemplateOneOf(string title = default(string), string body = default(string))
        {
            this.Title = title;
            this.Body = body;
        }
        ...
        {
            return this.Equals(input as SendTextMessageRequestBodyPushMessageTemplateOneOf);
        }

        /// <summary>
        /// Returns true if SendTextMessageRequestBodyPushMessageTemplateOneOf instances are equal
        /// </summary>
        /// <param name="input">Instance of SendTextMessageRequestBodyPushMessageTemplateOneOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SendTextMessageRequestBodyPushMessageTemplateOneOf input)
        {
            if (input == null)
                return false;
