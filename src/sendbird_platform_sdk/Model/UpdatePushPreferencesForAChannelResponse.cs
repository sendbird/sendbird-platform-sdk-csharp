...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdatePushPreferencesForAChannelResponse :  IEquatable<UpdatePushPreferencesForAChannelResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdatePushPreferencesForAChannelResponse" /> class.
        /// </summary>
        /// <param name="enable">enable.</param>
        /// <param name="pushSound">pushSound.</param>
        /// <param name="pushTriggerOption">pushTriggerOption.</param>
        public UpdatePushPreferencesForAChannelResponse(bool enable = default(bool), string pushSound = default(string), SendbirdPushTriggerOption pushTriggerOption = default(SendbirdPushTriggerOption))
        {
            this.Enable = enable;
        ...
        {
            return this.Equals(input as UpdatePushPreferencesForAChannelResponse);
        }

        /// <summary>
        /// Returns true if UpdatePushPreferencesForAChannelResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdatePushPreferencesForAChannelResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdatePushPreferencesForAChannelResponse input)
        {
            if (input == null)
                return false;
