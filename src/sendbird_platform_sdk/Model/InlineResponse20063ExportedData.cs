...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse20063ExportedData :  IEquatable<InlineResponse20063ExportedData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20063ExportedData" /> class.
        /// </summary>
        ...
        public InlineResponse20063ExportedData(string requestId = default(string), string status = default(string), string format = default(string), string csvDelimiter = default(string), string timezone = default(string), decimal createdAt = default(decimal), decimal startTs = default(decimal), decimal endTs = default(decimal), List<string> channelUrls = default(List<string>), List<string> senderIds = default(List<string>), InlineResponse20063File file = default(InlineResponse20063File), List<decimal> userIds = default(List<decimal>))
        {
        ...
        public InlineResponse20063File File { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse20063ExportedData);
        }

        /// <summary>
        /// Returns true if InlineResponse20063ExportedData instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20063ExportedData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20063ExportedData input)
        {
            if (input == null)
                return false;
