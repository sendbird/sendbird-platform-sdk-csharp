...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ViewNumberOfUnreadMessagesResponse :  IEquatable<ViewNumberOfUnreadMessagesResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ViewNumberOfUnreadMessagesResponse);
        }

        /// <summary>
        /// Returns true if ViewNumberOfUnreadMessagesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ViewNumberOfUnreadMessagesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ViewNumberOfUnreadMessagesResponse input)
        {
            if (input == null)
                return false;
