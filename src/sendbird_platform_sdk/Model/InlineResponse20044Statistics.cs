...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse20044Statistics :  IEquatable<InlineResponse20044Statistics>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20044Statistics" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as InlineResponse20044Statistics);
        }

        /// <summary>
        /// Returns true if InlineResponse20044Statistics instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20044Statistics to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20044Statistics input)
        {
            if (input == null)
                return false;
