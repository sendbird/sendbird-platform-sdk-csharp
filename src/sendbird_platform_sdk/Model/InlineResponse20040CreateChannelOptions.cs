...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse20040CreateChannelOptions :  IEquatable<InlineResponse20040CreateChannelOptions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20040CreateChannelOptions" /> class.
        /// </summary>
        ...
        public InlineResponse20040CreateChannelOptions(bool distinct = default(bool), string data = default(string), string name = default(string), string coverUrl = default(string), string customType = default(string))
        {
        ...
        {
            return this.Equals(input as InlineResponse20040CreateChannelOptions);
        }

        /// <summary>
        /// Returns true if InlineResponse20040CreateChannelOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20040CreateChannelOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20040CreateChannelOptions input)
        {
            if (input == null)
                return false;
