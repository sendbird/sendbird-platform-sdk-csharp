...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ViewAnnouncementByIdResponse :  IEquatable<ViewAnnouncementByIdResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ViewAnnouncementByIdResponse" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ViewAnnouncementByIdResponse);
        }

        /// <summary>
        /// Returns true if ViewAnnouncementByIdResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ViewAnnouncementByIdResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ViewAnnouncementByIdResponse input)
        {
            if (input == null)
                return false;
