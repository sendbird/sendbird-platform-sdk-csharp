...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ListReportsResponseReportLogs :  IEquatable<ListReportsResponseReportLogs>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ListReportsResponseReportLogs);
        }

        /// <summary>
        /// Returns true if ListReportsResponseReportLogs instances are equal
        /// </summary>
        /// <param name="input">Instance of ListReportsResponseReportLogs to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListReportsResponseReportLogs input)
        {
            if (input == null)
                return false;
