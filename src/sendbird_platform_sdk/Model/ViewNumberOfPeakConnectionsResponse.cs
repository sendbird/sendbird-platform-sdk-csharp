...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ViewNumberOfPeakConnectionsResponse :  IEquatable<ViewNumberOfPeakConnectionsResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ViewNumberOfPeakConnectionsResponse);
        }

        /// <summary>
        /// Returns true if ViewNumberOfPeakConnectionsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ViewNumberOfPeakConnectionsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ViewNumberOfPeakConnectionsResponse input)
        {
            if (input == null)
                return false;
