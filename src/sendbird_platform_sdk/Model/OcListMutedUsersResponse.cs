...
namespace sendbird_platform_sdk.Model
{
    ...
    public partial class OcListMutedUsersResponse :  IEquatable<OcListMutedUsersResponse>, IValidatableObject
    {
        ...
        public OcListMutedUsersResponse(List<SendBirdUser> mutedList = default(List<SendBirdUser>), decimal totalMuteCount = default(decimal), string next = default(string))
        {
