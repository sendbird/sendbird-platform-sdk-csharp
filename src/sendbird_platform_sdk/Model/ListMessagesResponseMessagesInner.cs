...
namespace sendbird_platform_sdk.Model
{
    ...
    public partial class ListMessagesResponseMessagesInner :  IEquatable<ListMessagesResponseMessagesInner>, IValidatableObject
    {
        ...
        public ListMessagesResponseMessagesInner(decimal messageSurvivalSeconds = default(decimal), string customType = default, List<SendBirdMessageResponseMentionedUsersInner> mentionedUsers = default(List<SendBirdMessageResponseMentionedUsersInner>), Object translations = default, decimal updatedAt = default(decimal), bool isOpMsg = default(bool), bool isRemoved = default(bool), SendBirdMessageResponseUser user = default(SendBirdMessageResponseUser), Object file = default, string message = default, string data = default, decimal messageRetentionHour = default(decimal), bool silent = default(bool), string type = default, decimal createdAt = default(decimal), string channelType = default, string reqId = default, string mentionType = default, string channelUrl = default, decimal messageId = default(decimal), List<ListMessagesResponseMessagesInnerSortedMetaarrayInner> sortedMetaarray = default(List<ListMessagesResponseMessagesInnerSortedMetaarrayInner>), ListMessagesResponseMessagesInnerOgTag ogTag = default(ListMessagesResponseMessagesInnerOgTag))
        {
