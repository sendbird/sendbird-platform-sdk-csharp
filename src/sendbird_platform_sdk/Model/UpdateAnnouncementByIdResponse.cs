...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateAnnouncementByIdResponse :  IEquatable<UpdateAnnouncementByIdResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAnnouncementByIdResponse" /> class.
        /// </summary>
        ...
        public UpdateAnnouncementByIdResponseMessage Message { get; set; }
        ...
        {
            return this.Equals(input as UpdateAnnouncementByIdResponse);
        }

        /// <summary>
        /// Returns true if UpdateAnnouncementByIdResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateAnnouncementByIdResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateAnnouncementByIdResponse input)
        {
            if (input == null)
                return false;
