...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ListDataExportsByMessageChannelOrUserResponseExportedData :  IEquatable<ListDataExportsByMessageChannelOrUserResponseExportedData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListDataExportsByMessageChannelOrUserResponseExportedData" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ListDataExportsByMessageChannelOrUserResponseExportedData);
        }

        /// <summary>
        /// Returns true if ListDataExportsByMessageChannelOrUserResponseExportedData instances are equal
        /// </summary>
        /// <param name="input">Instance of ListDataExportsByMessageChannelOrUserResponseExportedData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListDataExportsByMessageChannelOrUserResponseExportedData input)
        {
            if (input == null)
                return false;
