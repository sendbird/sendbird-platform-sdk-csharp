...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ListMessagesResponseMessages :  IEquatable<ListMessagesResponseMessages>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ListMessagesResponseMessages);
        }

        /// <summary>
        /// Returns true if ListMessagesResponseMessages instances are equal
        /// </summary>
        /// <param name="input">Instance of ListMessagesResponseMessages to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListMessagesResponseMessages input)
        {
            if (input == null)
                return false;
