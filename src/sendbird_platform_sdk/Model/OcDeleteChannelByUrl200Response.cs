...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OcDeleteChannelByUrl200Response :  IEquatable<OcDeleteChannelByUrl200Response>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as OcDeleteChannelByUrl200Response);
        }

        /// <summary>
        /// Returns true if OcDeleteChannelByUrl200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of OcDeleteChannelByUrl200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OcDeleteChannelByUrl200Response input)
        {
            if (input == null)
                return false;
