...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ViewNumberOfPeakConnectionsResponsePeakConnectionsInner :  IEquatable<ViewNumberOfPeakConnectionsResponsePeakConnectionsInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ViewNumberOfPeakConnectionsResponsePeakConnectionsInner" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ViewNumberOfPeakConnectionsResponsePeakConnectionsInner);
        }

        /// <summary>
        /// Returns true if ViewNumberOfPeakConnectionsResponsePeakConnectionsInner instances are equal
        /// </summary>
        /// <param name="input">Instance of ViewNumberOfPeakConnectionsResponsePeakConnectionsInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ViewNumberOfPeakConnectionsResponsePeakConnectionsInner input)
        {
            if (input == null)
                return false;
