...
namespace sendbird_platform_sdk.Model
{
    ...
    public partial class OcListBannedUsersResponse :  IEquatable<OcListBannedUsersResponse>, IValidatableObject
    {
        ...
        public OcListBannedUsersResponse(List<OcListBannedUsersResponseBannedList> bannedList = default(List<OcListBannedUsersResponseBannedList>), decimal totalBanCount = default(decimal), string next = default(string))
        {
