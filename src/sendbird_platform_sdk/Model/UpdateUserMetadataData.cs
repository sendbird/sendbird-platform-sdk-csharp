...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateUserMetadataData :  IEquatable<UpdateUserMetadataData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateUserMetadataData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateUserMetadataData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateUserMetadataData" /> class.
        /// </summary>
        ...
        public UpdateUserMetadataData(Object metadata = default(Object), bool upsert = default(bool))
        {
            // to ensure "metadata" is required (not null)
            if (metadata == null)
            {
                throw new InvalidDataException("metadata is a required property for UpdateUserMetadataData and cannot be null");
            }
            else
            {
            ...
            if (upsert == null)
            {
                throw new InvalidDataException("upsert is a required property for UpdateUserMetadataData and cannot be null");
            }
            else
            {
                this.Upsert = upsert;
        ...
        {
            return this.Equals(input as UpdateUserMetadataData);
        }

        /// <summary>
        /// Returns true if UpdateUserMetadataData instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateUserMetadataData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateUserMetadataData input)
        {
            if (input == null)
                return false;
