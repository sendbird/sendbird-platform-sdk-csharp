...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V3ApplicationsSettingsGlobalCustomTypeImageModerationLimits :  IEquatable<V3ApplicationsSettingsGlobalCustomTypeImageModerationLimits>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3ApplicationsSettingsGlobalCustomTypeImageModerationLimits" /> class.
        /// </summary>
        ...
        public V3ApplicationsSettingsGlobalCustomTypeImageModerationLimits(int adult = default(int), int spoof = default(int), int medical = default(int), int violence = default(int), int racy = default(int))
        {
            this.Adult = adult;
            this.Spoof = spoof;
        ...
        {
            return this.Equals(input as V3ApplicationsSettingsGlobalCustomTypeImageModerationLimits);
        }

        /// <summary>
        /// Returns true if V3ApplicationsSettingsGlobalCustomTypeImageModerationLimits instances are equal
        /// </summary>
        /// <param name="input">Instance of V3ApplicationsSettingsGlobalCustomTypeImageModerationLimits to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3ApplicationsSettingsGlobalCustomTypeImageModerationLimits input)
        {
            if (input == null)
                return false;
