...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SendAMessageRequestPushMessageTemplateOneOf :  IEquatable<SendAMessageRequestPushMessageTemplateOneOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SendAMessageRequestPushMessageTemplateOneOf" /> class.
        /// </summary>
        ...
        public SendAMessageRequestPushMessageTemplateOneOf(string title = default(string), string body = default(string))
        {
            this.Title = title;
            this.Body = body;
        }
        ...
        {
            return this.Equals(input as SendAMessageRequestPushMessageTemplateOneOf);
        }

        /// <summary>
        /// Returns true if SendAMessageRequestPushMessageTemplateOneOf instances are equal
        /// </summary>
        /// <param name="input">Instance of SendAMessageRequestPushMessageTemplateOneOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SendAMessageRequestPushMessageTemplateOneOf input)
        {
            if (input == null)
                return false;
