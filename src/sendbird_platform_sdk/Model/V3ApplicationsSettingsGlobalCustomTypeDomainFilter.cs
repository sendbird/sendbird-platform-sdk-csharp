...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V3ApplicationsSettingsGlobalCustomTypeDomainFilter :  IEquatable<V3ApplicationsSettingsGlobalCustomTypeDomainFilter>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V3ApplicationsSettingsGlobalCustomTypeDomainFilter" /> class.
        /// </summary>
        /// <param name="domains">domains.</param>
        /// <param name="type">type.</param>
        /// <param name="shouldCheckGlobal">shouldCheckGlobal.</param>
        public V3ApplicationsSettingsGlobalCustomTypeDomainFilter(List<string> domains = default(List<string>), int type = default(int), bool shouldCheckGlobal = default(bool))
        {
        ...
        {
            return this.Equals(input as V3ApplicationsSettingsGlobalCustomTypeDomainFilter);
        }

        /// <summary>
        /// Returns true if V3ApplicationsSettingsGlobalCustomTypeDomainFilter instances are equal
        /// </summary>
        /// <param name="input">Instance of V3ApplicationsSettingsGlobalCustomTypeDomainFilter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V3ApplicationsSettingsGlobalCustomTypeDomainFilter input)
        {
            if (input == null)
                return false;
