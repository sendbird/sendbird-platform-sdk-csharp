...
namespace sendbird_platform_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ListReportsResponseReportLogsInner :  IEquatable<ListReportsResponseReportLogsInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListReportsResponseReportLogsInner" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ListReportsResponseReportLogsInner);
        }

        /// <summary>
        /// Returns true if ListReportsResponseReportLogsInner instances are equal
        /// </summary>
        /// <param name="input">Instance of ListReportsResponseReportLogsInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListReportsResponseReportLogsInner input)
        {
            if (input == null)
                return false;
