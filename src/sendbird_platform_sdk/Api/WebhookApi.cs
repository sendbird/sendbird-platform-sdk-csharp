...
namespace sendbird_platform_sdk.Api
{
    ...
    public partial class WebhookApi : IWebhookApi
    {
        ...
        /// <returns></returns>
        public WebhookApi(sendbird_platform_sdk.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse<ChooseWhichEventsToSubscribeToResponse> ChooseWhichEventsToSubscribeToWithHttpInfo (string apiToken, ChooseWhichEventsToSubscribeToData chooseWhichEventsToSubscribeToData = default(ChooseWhichEventsToSubscribeToData))
        {
            ...
            if (apiToken == null)
                throw new ApiException(400, "Missing required parameter 'apiToken' when calling WebhookApi->ChooseWhichEventsToSubscribeTo");
        ...
        public ApiResponse<RetrieveListOfSubscribedEventsResponse> RetrieveListOfSubscribedEventsWithHttpInfo (string apiToken, bool? displayAllWebhookCategories = default(bool?))
        {
            // verify the required parameter 'apiToken' is set
            if (apiToken == null)
                throw new ApiException(400, "Missing required parameter 'apiToken' when calling WebhookApi->RetrieveListOfSubscribedEvents");
