...
namespace sendbird_platform_sdk.Api
{
    ...
    /// </summary>
    public interface IPrivacyApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class PrivacyApi : IPrivacyApi
    {
        private sendbird_platform_sdk.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="PrivacyApi"/> class.
        /// </summary>
        /// <returns></returns>
        public PrivacyApi(String basePath)
        {
        ...
        /// <returns></returns>
        public PrivacyApi(sendbird_platform_sdk.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse<Object> CancelTheRegistrationOfGdprRequestByIdWithHttpInfo (string apiToken, string requestId)
        {
            ...
            if (apiToken == null)
                throw new ApiException(400, "Missing required parameter 'apiToken' when calling PrivacyApi->CancelTheRegistrationOfGdprRequestById");
            // verify the required parameter 'requestId' is set
            if (requestId == null)
                throw new ApiException(400, "Missing required parameter 'requestId' when calling PrivacyApi->CancelTheRegistrationOfGdprRequestById");
        ...
        public ApiResponse<ListGdprRequestsResponse> ListGdprRequestsWithHttpInfo (string apiToken, string token = default, int? limit = default)
        {
            // verify the required parameter 'apiToken' is set
            if (apiToken == null)
                throw new ApiException(400, "Missing required parameter 'apiToken' when calling PrivacyApi->ListGdprRequests");
        ...
        public ApiResponse<RegisterGdprRequestResponse> RegisterGdprRequestWithHttpInfo (string apiToken, RegisterGdprRequestData registerGdprRequestData = default(RegisterGdprRequestData))
        {
            // verify the required parameter 'apiToken' is set
            if (apiToken == null)
                throw new ApiException(400, "Missing required parameter 'apiToken' when calling PrivacyApi->RegisterGdprRequest");
        ...
        public ApiResponse<ViewGdprRequestByIdResponse> ViewGdprRequestByIdWithHttpInfo (string apiToken, string requestId)
        {
            // verify the required parameter 'apiToken' is set
            if (apiToken == null)
                throw new ApiException(400, "Missing required parameter 'apiToken' when calling PrivacyApi->ViewGdprRequestById");
            // verify the required parameter 'requestId' is set
            if (requestId == null)
                throw new ApiException(400, "Missing required parameter 'requestId' when calling PrivacyApi->ViewGdprRequestById");
