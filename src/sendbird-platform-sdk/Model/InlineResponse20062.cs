...
namespace sendbird-platform-sdk.Model
{
    ...
    public partial class InlineResponse20062 :  IEquatable<InlineResponse20062>, IValidatableObject
    {
        ...
        public InlineResponse20062(string segments = default(string), string date = default(string), decimal value = default(decimal), string channelType = default(string), string customChannelType = default(string), string customMessageType = default(string))
        {
