...
namespace sendbird-platform-sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ReportChannelByUrlData :  IEquatable<ReportChannelByUrlData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReportChannelByUrlData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ReportChannelByUrlData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ReportChannelByUrlData" /> class.
        /// </summary>
        /// <param name="channelType">Specifies the type of the channel. Either open_channels or group_channels..</param>
        /// <param name="channelUrl">Specifies the URL of the channel to report for offensive messages or inappropriate activities..</param>
        ...
        public ReportChannelByUrlData(string channelType = default(string), string channelUrl = default(string), string reportCategory = default(string), string reportingUserId = default(string), string reportDescription = default(string))
        {
            ...
            {
                throw new InvalidDataException("reportCategory is a required property for ReportChannelByUrlData and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Specifies the URL of the channel to report for offensive messages or inappropriate activities.</value>
        ...
        /// </summary>
        /// <value>Specifies the unique ID of the user who reports the channel.</value>
        ...
        {
            return this.Equals(input as ReportChannelByUrlData);
        }

        /// <summary>
        /// Returns true if ReportChannelByUrlData instances are equal
        /// </summary>
        /// <param name="input">Instance of ReportChannelByUrlData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReportChannelByUrlData input)
        {
            if (input == null)
                return false;
