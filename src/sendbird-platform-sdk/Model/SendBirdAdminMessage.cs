...
namespace sendbird-platform-sdk.Model
{
    ...
    public partial class SendBirdAdminMessage :  IEquatable<SendBirdAdminMessage>, IValidatableObject
    {
        ...
        public SendBirdAdminMessage(SendBirdAppleCriticalAlertOptions appleCriticalAlertOptions = default(SendBirdAppleCriticalAlertOptions), string channelType = default(string), string channelUrl = default(string), decimal createdAt = default(decimal), string customType = default(string), string data = default(string), bool isReplyToChannel = default(bool), string mentionType = default(string), List<SendBirdUser> mentionedUsers = default(List<SendBirdUser>), string message = default(string), decimal messageId = default(decimal), MessageTypeEnum? messageType = default(MessageTypeEnum?), Object metaArray = default(Object), List<SendBirdMessageMetaArray> metaArrays = default(List<SendBirdMessageMetaArray>), SendBirdOGMetaData ogMetaData = default(SendBirdOGMetaData), SendBirdMessageResponse parentMessage = default(SendBirdMessageResponse), decimal parentMessageId = default(decimal), string parentMessageText = default(string), List<SendBirdReaction> reactions = default(List<SendBirdReaction>), SendingStatusEnum? sendingStatus = default(SendingStatusEnum?), bool silent = default(bool), SendBirdThreadInfo threadInfo = default(SendBirdThreadInfo), Object translations = default(Object), decimal updatedAt = default(decimal))
        {
        ...
        public Object MetaArray { get; set; }
