...
namespace sendbird-platform-sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SendBirdThumbnailObject :  IEquatable<SendBirdThumbnailObject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SendBirdThumbnailObject" /> class.
        /// </summary>
        ...
        public SendBirdThumbnailObject(decimal height = default(decimal), string plainUrl = default(string), decimal realHeight = default(decimal), decimal realWidth = default(decimal), string url = default(string), decimal width = default(decimal))
        {
            this.Height = height;
        ...
        {
            return this.Equals(input as SendBirdThumbnailObject);
        }

        /// <summary>
        /// Returns true if SendBirdThumbnailObject instances are equal
        /// </summary>
        /// <param name="input">Instance of SendBirdThumbnailObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SendBirdThumbnailObject input)
        {
            if (input == null)
                return false;
