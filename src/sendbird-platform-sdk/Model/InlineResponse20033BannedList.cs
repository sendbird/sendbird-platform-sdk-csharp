...
namespace sendbird-platform-sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse20033BannedList :  IEquatable<InlineResponse20033BannedList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20033BannedList" /> class.
        /// </summary>
        /// <param name="user">user.</param>
        /// <param name="startAt">startAt.</param>
        /// <param name="endAt">endAt.</param>
        /// <param name="description">description.</param>
        public InlineResponse20033BannedList(SendBirdUser user = default(SendBirdUser), decimal startAt = default(decimal), decimal endAt = default(decimal), string description = default(string))
        {
            this.User = user;
        ...
        {
            return this.Equals(input as InlineResponse20033BannedList);
        }

        /// <summary>
        /// Returns true if InlineResponse20033BannedList instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20033BannedList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20033BannedList input)
        {
            if (input == null)
                return false;
