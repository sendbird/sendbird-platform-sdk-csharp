...
namespace sendbird-platform-sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ReportUserByIdData :  IEquatable<ReportUserByIdData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReportUserByIdData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ReportUserByIdData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ReportUserByIdData" /> class.
        /// </summary>
        /// <param name="offendingUserId">Specifies the unique ID of the user to report for using offensive or abusive language such as sending explicit messages or inappropriate comments. (required).</param>
        /// <param name="channelType">Specifies the type of the channel. Either open_channels or group_channels..</param>
        /// <param name="channelUrl">Specifies the URL of the channel where the user to report is in..</param>
        ...
        /// <param name="reportingUserId">Specifies the unique ID of the user who reports the offending user..</param>
        /// <param name="reportDescription">Specifies additional information to be included in the report..</param>
        public ReportUserByIdData(string offendingUserId = default(string), string channelType = default(string), string channelUrl = default(string), string reportCategory = default(string), string reportingUserId = default(string), string reportDescription = default(string))
        {
            // to ensure "offendingUserId" is required (not null)
            if (offendingUserId == null)
            {
                throw new InvalidDataException("offendingUserId is a required property for ReportUserByIdData and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("reportCategory is a required property for ReportUserByIdData and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Specifies the unique ID of the user to report for using offensive or abusive language such as sending explicit messages or inappropriate comments.</value>
        ...
        /// </summary>
        /// <value>Specifies the URL of the channel where the user to report is in.</value>
        ...
        /// </summary>
        /// <value>Specifies the unique ID of the user who reports the offending user.</value>
        ...
        {
            return this.Equals(input as ReportUserByIdData);
        }

        /// <summary>
        /// Returns true if ReportUserByIdData instances are equal
        /// </summary>
        /// <param name="input">Instance of ReportUserByIdData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReportUserByIdData input)
        {
            if (input == null)
                return false;
