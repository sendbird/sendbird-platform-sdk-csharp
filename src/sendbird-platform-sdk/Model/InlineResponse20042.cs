...
namespace sendbird-platform-sdk.Model
{
    ...
    public partial class InlineResponse20042 :  IEquatable<InlineResponse20042>, IValidatableObject
    {
        ...
        public InlineResponse20042(string uniqueId = default(string), List<decimal> openCounts = default(List<decimal>), List<decimal> openRates = default(List<decimal>), List<decimal> cumulativeOpenCounts = default(List<decimal>), List<decimal> cumulativeOpenRates = default(List<decimal>))
        {
