...
namespace sendbird-platform-sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse20065Bots :  IEquatable<InlineResponse20065Bots>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20065Bots" /> class.
        /// </summary>
        ...
        public InlineResponse20065Bots(InlineResponse20065Bot bot = default(InlineResponse20065Bot), string botCallbackUrl = default(string), bool enableMarkAsRead = default(bool), bool isPrivacyMode = default(bool), bool showMember = default(bool), decimal channelInvitationPreference = default(decimal))
        {
            this.Bot = bot;
        ...
        public InlineResponse20065Bot Bot { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse20065Bots);
        }

        /// <summary>
        /// Returns true if InlineResponse20065Bots instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20065Bots to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20065Bots input)
        {
            if (input == null)
                return false;
