...
namespace sendbird-platform-sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse20041Message :  IEquatable<InlineResponse20041Message>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20041Message" /> class.
        /// </summary>
        ...
        public InlineResponse20041Message(string type = default(string), string customType = default(string), string userId = default(string), string content = default(string), string data = default(string), bool enablePush = default(bool), string targetAt = default(string), decimal targetUserCount = default(decimal), decimal targetChannelCount = default(decimal), string status = default(string), decimal scheduledAt = default(decimal), decimal completedAt = default(decimal), decimal sentUserCount = default(decimal), decimal openCount = default(decimal), decimal openRate = default(decimal))
        {
            this.Type = type;
        ...
        {
            return this.Equals(input as InlineResponse20041Message);
        }

        /// <summary>
        /// Returns true if InlineResponse20041Message instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20041Message to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20041Message input)
        {
            if (input == null)
                return false;
